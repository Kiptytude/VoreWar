...
class Hamsters : BlankSlate
{
    public Hamsters()
    {
        AccessoryColors = 5;
        Body = new SpriteExtraInfo(2, BodySprite, null, (s) => ColorPaletteMap.GetPalette(ColorPaletteMap.SwapType.Hamsters, s.Unit.AccessoryColor));
        BodyAccent = new SpriteExtraInfo(4, BodyAccentSprite, null, (s) => ColorPaletteMap.GetPalette(ColorPaletteMap.SwapType.Hamsters, s.Unit.AccessoryColor));
        BodyAccent2 = new SpriteExtraInfo(0, BodyAccentSprite2, null, (s) => ColorPaletteMap.GetPalette(ColorPaletteMap.SwapType.Hamsters, s.Unit.AccessoryColor));
        BodyAccent3 = new SpriteExtraInfo(4, BodyAccentSprite3, null, (s) => ColorPaletteMap.GetPalette(ColorPaletteMap.SwapType.Hamsters, s.Unit.AccessoryColor));
        Head = new SpriteExtraInfo(1, HeadSprite, null, (s) => ColorPaletteMap.GetPalette(ColorPaletteMap.SwapType.Hamsters, s.Unit.AccessoryColor));
        Mouth = new SpriteExtraInfo(2, MouthSprite, null, (s) => ColorPaletteMap.GetPalette(ColorPaletteMap.SwapType.Hamsters, s.Unit.AccessoryColor));
        Eyes = new SpriteExtraInfo(2, EyesSprite, null, (s) => ColorPaletteMap.GetPalette(ColorPaletteMap.SwapType.Hamsters, s.Unit.AccessoryColor));
        Belly = new SpriteExtraInfo(15, null, null, (s) => ColorPaletteMap.GetPalette(ColorPaletteMap.SwapType.Hamsters, s.Unit.AccessoryColor));
        Weapon = new SpriteExtraInfo(3, WeaponSprite, WhiteColored);
        Breasts = new SpriteExtraInfo(16, BreastsSprite, null, (s) => ColorPaletteMap.GetPalette(ColorPaletteMap.SwapType.Hamsters, s.Unit.AccessoryColor));
        Dick = new SpriteExtraInfo(9, DickSprite, null, (s) => ColorPaletteMap.GetPalette(ColorPaletteMap.SwapType.Hamsters, s.Unit.AccessoryColor));
        Balls = new SpriteExtraInfo(8, BallsSprite, null, (s) => ColorPaletteMap.GetPalette(ColorPaletteMap.SwapType.HamstersBalls, s.Unit.AccessoryColor));
        EyeTypes = 5;
        MouthTypes = 5;
    ...
    protected override Sprite BodySprite(Actor_Unit actor)
    {
        if (actor.IsAttacking)
            return State.GameManager.SpriteDictionary.Hamsters[1];
        else if (actor.IsAnalVoring)
            return State.GameManager.SpriteDictionary.Hamsters[2];
        else
            return State.GameManager.SpriteDictionary.Hamsters[0];
    }
    ...
    {
        return State.GameManager.SpriteDictionary.Hamsters[8 + actor.Unit.EyeType];
    }
    ...
    protected override Sprite DickSprite(Actor_Unit actor)
    {
        ...
        if (actor.IsErect())
        {
            ...
            {
                Dick.layer = 18;
                return State.GameManager.SpriteDictionary.Hamsters[33 + actor.Unit.DickSize];
            }
            else
            {
                Dick.layer = 12;
                return State.GameManager.SpriteDictionary.Hamsters[30 + actor.Unit.DickSize];
            }
        }
    ...
    protected override Sprite WeaponSprite(Actor_Unit actor)
    {
        if (actor.Unit.HasWeapon && actor.Surrendered == false)
        {
            ...
            {
                return State.GameManager.SpriteDictionary.Hamsters[5 + pose];
            }
            else
            {
                Weapon.layer = -1;
                return State.GameManager.SpriteDictionary.Hamsters[13 + pose];
            }
    ...
    internal override Sprite BellySprite(Actor_Unit actor, GameObject belly)
    {
        if (actor.HasBelly)
        {
            ...
            if (actor.PredatorComponent.IsUnitOfSpecificationInPrey(Race.Selicia, true, PreyLocation.stomach, PreyLocation.womb) && actor.GetStomachSize(9) == 9)
            {
                ...
                return State.GameManager.SpriteDictionary.Hamsters[50];
            }
            ...
            {
                belly.transform.localScale = new Vector3(1, 1, 1);
                return State.GameManager.SpriteDictionary.Hamsters[49];
            }
            ...
            if (actor.PredatorComponent.VisibleFullness > 4)
            {
                ...
                belly.transform.localScale = new Vector3(1, 1, 1);
            return State.GameManager.SpriteDictionary.Hamsters[37 + actor.GetStomachSize(9)];
        }
        else
        {
            return null;
    ...
    protected override Sprite BreastsSprite(Actor_Unit actor)
    {
        if (actor.Unit.HasBreasts)
            return State.GameManager.SpriteDictionary.Hamsters[26];
        return null;
    }

    protected override Sprite BodyAccentSprite(Actor_Unit actor)
    {
        return State.GameManager.SpriteDictionary.Hamsters[23];
    }

    protected override Sprite BodyAccentSprite2(Actor_Unit actor)
    {
        return State.GameManager.SpriteDictionary.Hamsters[24];
    }

    protected override Sprite BodyAccentSprite3(Actor_Unit actor)
    {
        if (actor.Unit.HasBreasts)
            return State.GameManager.SpriteDictionary.Hamsters[27];
        return null;
    }
    ...
    class Vest : MainClothing
    {
        ...
        public override void Configure(CompleteSprite sprite, Actor_Unit actor)
        {
            ...
            clothing1.GetSprite = (s) => State.GameManager.SpriteDictionary.Hamsters[spriteNum];
