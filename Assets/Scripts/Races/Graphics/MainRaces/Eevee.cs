...
//    bool BreastBlocked = false; // Carry over from Umbreon code
    ...
    public Eevee()
    {
        ...
        BodyAccessory = new SpriteExtraInfo(20, AccessorySprite, null, (s) => ColorPaletteMap.GetPalette(ColorPaletteMap.SwapType.EeveeEqualeonSkin, s.Unit.AccessoryColor)); // fluff
        BodyAccent = new SpriteExtraInfo(5, BodyAccentSprite, WhiteColored); // rub blush
        BodyAccent2 = new SpriteExtraInfo(1, BodyAccentSprite2, null, (s) => ColorPaletteMap.GetPalette(ColorPaletteMap.SwapType.EeveeEqualeonSkin, s.Unit.AccessoryColor)); // Tail 
        BodyAccent3 = null;
        BodyAccent4 = null; 
        BodyAccent5 = null; 
        BodyAccent6 = null;
    ...
    protected override Sprite BodyAccentSprite(Actor_Unit actor) => actor.IsBeingRubbed ? State.GameManager.SpriteDictionary.Eevee[26] : null;
    ...
    protected override Sprite BodyAccentSprite3(Actor_Unit actor) => null;
    protected override Sprite BodyAccentSprite4(Actor_Unit actor) => null;
    ...
    protected override Sprite EyesSprite(Actor_Unit actor)
    {
        ...
        {
            return State.GameManager.SpriteDictionary.Eevee[25];
        }
        if (actor.Unit.IsDead)
        {
            return State.GameManager.SpriteDictionary.Eevee[24];
        }
        else
            return State.GameManager.SpriteDictionary.Eevee[3 + actor.Unit.EyeColor];
    }
