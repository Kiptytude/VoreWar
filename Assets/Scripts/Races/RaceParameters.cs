...
static class RaceParameters
{
    ...
    static RaceParameters()
    {
            ...
            RacialTraits = new List<Traits>()
        {
            Traits.ArtfulDodge,
            Traits.ThrillSeeker,
            RandomizeListUtils.CreateLevelTree("Fox",TraitListType.Race,new List<Traits>(){Traits.Skinwalker,Traits.GreaterChangeling,Traits.FastCaster,Traits.Clever,},2,1),
        },
        ...
        Youko = new RaceTraits()
        {
            ...
            RacialTraits = new List<Traits>()
            {
                ...
                Traits.ManaDrain,
                Traits.CreateSpawn,
                RandomizeListUtils.CreateLevelTree("Youko",TraitListType.Race,new List<Traits>(){Traits.FastCaster,Traits.StretchyInsides,Traits.ManaDrain,Traits.ManaRich,Traits.Extraction,Traits.Assimilate,Traits.FleetingGrowth,Traits.Colossal},2,1),
            },
