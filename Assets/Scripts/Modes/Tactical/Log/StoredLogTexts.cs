...
static class StoredLogTexts
{
    ...
    internal static void InitializeLists()
    {
        ...
        AbsorptionMessages = new List<EventString>()
        {
            ...
            targetRace: Race.FeralOrcas, priority: 9, conditional: s => SizeDiffPrey(s, 0.75f)),
            ...
            targetRace: Race.FeralOrcas, priority: 9, conditional: s => SizeDiffPrey(s, 1.5f) && Scat(s)),
            ...
            targetRace: Race.FeralOrcas, priority: 9, conditional: s => SizeDiffPrey(s, 0.75f) && Scat(s)),
