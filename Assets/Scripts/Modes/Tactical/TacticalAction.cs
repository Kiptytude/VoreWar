...
static class TacticalActionList
{
    ...
    static TacticalActionList()
    {
        ...
        UntargetedActions.Add(new UntargetedTacticalAction("Shift", () => State.GameManager.TacticalMode.ButtonCallback(14), (a) => a.Unit.ShifterShapes != null && a.Unit.ShifterShapes.Count > 1));
